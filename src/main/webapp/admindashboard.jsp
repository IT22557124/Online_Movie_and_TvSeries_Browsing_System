		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			  <ul class="navbar-nav mb-0">
				...
				<li class="nav-item">
					<a class="nav-link" href="celebrity.html">Celebrity</a>
				</li>
			  ...
			  <ul class="navbar-nav mb-0 ms-auto">
				...
				<button class="nav-link button" data-bs-toggle="modal" data-bs-target="#signup-modal" type="submit">Logout</button>
				</form>
				</span>
				</li>
				<!-- /.modal -->
            ...
            <tr>
                <td>
                    <div class="side">
                        ...
                        <a href="admindashboard.jsp" class="link">Dashboard</a><br>
                        <a href="ManageUsers.jsp" class="link">Manage Users</a><br>
                        <a href="ManageMovies.jsp" class="link">Manage Movies</a><br>
                        <a href="ManageTVSeries.jsp" class="link">Manage TV Series</a><br>
                        <a href="ManageCelebrities.jsp" class="link">Manage Celebrities</a><br>
