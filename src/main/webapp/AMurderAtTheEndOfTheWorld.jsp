...
<section id="center" class="center_o pt-5">
 <div class="container">
   <div class="row center_o1 text-center">
    <div class="col-md-12">
	  <h2>TV-SERIES</h2>
	  <h5 class="bg_dark d-inline-block p-4 mb-0 mt-4 pt-2 pb-2 fw-normal col_red"><a class="text-white" href="#">HOME</a>  <span class="me-2 ms-2 text-muted"> /</span>TV-SERIES</h5>
	</div>
   </div>
  </div>
</section>
   ...
   <div class="row event1 mt-3">
	  ...
	  <div class="event1l">
	    <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image\TVSeries\murder.jpg" height="428" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
	  </div>
	 </div>
	 <div class="col-md-6 ps-0">
	  <div class="event1r bg-white p-4 shadow_box">
        <h5 class="text-uppercase"><a href="#">A Murder at the End of the World</a></h5>
		  
			 <hr>
			 
			 <p class="mt-3">A Murder at the End of the World" is a mystery series with a new kind of detective at the helm -- a Gen Z amateur sleuth and tech-savvy hacker named Darby Hart. In the new limited series, Darby and eight other guests are invited by a reclusive billionaire to participate in a retreat at a remote and dazzling location. When one of the other guests is found dead, Darby must put to use all of her combined skills to prove it was in fact murder, all against a tide of competing interests and before the killer takes another life.</p>
             <p>First episode date: November 14, 2023 (USA)</p>
            <p> Created by: Brit Marling; Zal Batmanglij</p>
            <p>Genre: Murder mystery; Psychological thriller</p>
            <p> Original network: FX on Hulu</p>
            <p>Production companies: Sound of My Voice; Alien She; FXP</p>
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
       <div class="events_1i row">
	    <div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\traitor.jpg" alt="abc" class="w-100">
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
			<h5 class="text-uppercase"><a href="#">The Traitors Canada</a></h5>
		...
		<div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\chantal.jpeg" alt="abc" class="w-100">
		  </div>
		  <div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
		    <h6 class="mb-0"><a class="button_1" href="#">Watch Now </a></h6>
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
		  <h5 class="text-uppercase"><a href="#">Chantal</a></h5>
		...
		<div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\meaning.webp" alt="abc" class="w-100">
		  </div>
		  <div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
		    <h6 class="mb-0"><a class="button_1" href="#">Watch Now </a></h6>
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
		  <h5 class="text-uppercase"><a href="#">Meaning of Life</a></h5>
    ...
    <div class="carousel-item active">
	    ...
	    <div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\devil.jpg" alt="abc" class="w-100">
		  </div>
		  <div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
		    <h6 class="mb-0"><a class="button_1" href="#">Watch Now </a></h6>
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
		  <h5 class="text-uppercase"><a href="#">The Devil's Plan</a></h5>
		...
		<div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\worst.jpeg" alt="abc" class="w-100">
		  </div>
		  <div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
		    <h6 class="mb-0"><a class="button_1" href="#">Watch Now </a></h6>
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
		  <h5 class="text-uppercase"><a href="#">The Worst of Evil</a></h5>
		...
		<div class="col-md-4">
		 <div class="events_1i1 clearfix position-relative">
		  <div class="events_1i1i clearfix">
		    <img src="image\TVSeries\krapopolis.jpg" alt="abc" class="w-100">
		  </div>
		  <div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
		    <h6 class="mb-0"><a class="button_1" href="#">Watch Now </a></h6>
		  </div>
		 ...
		 <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-light">
		  <h5 class="text-uppercase"><a href="#">Krapopolis</a></h5>
