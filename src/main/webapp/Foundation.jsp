   ...
   <div class="row event1 mt-3">
	  ...
	  <div class="event1l">
	    <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image\TVSeries\foundation.jpg" height="428" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
	  </div>
	 </div>
	 <div class="col-md-6 ps-0">
	  <div class="event1r bg-white p-4 shadow_box">
        <h5 class="text-uppercase"><a href="#">Foundation</a></h5>
		  
			 <hr>
			 
			 <p class="mt-3">A complex saga of humans scattered on planets throughout the galaxy all living under the rule of the Galactic Empire. Dr Hari Seldon and his loyal followers attempt to preserve their culture as the galaxy collapses around them.</p>
             <p>Based on: Foundation; by Isaac Asimov</p>
            </p>Budget: $69 million (season 1)</p>
            </p>Composer: Bear McCreary;</p>
            </p>Created by: David S. Goyer; Josh Friedman</p>
            </p>Genre: Drama; Science fiction</p>
            </p>Original network: Apple TV+</p>
