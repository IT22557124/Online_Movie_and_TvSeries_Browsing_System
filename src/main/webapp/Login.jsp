			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			  ...
			  <ul class="navbar-nav mb-0 ms-auto">
				...
				<li class="nav-item ms-3">
				  <a class="nav-link button" data-bs-toggle="modal" data-bs-target="#signup-modal" href="#">SIGN IN</a>
				</li>
				<!-- /.modal -->
		...
		<section id="form" style="background-image:url('image/movie_bg2.webp'); background-size: cover; background-position: center;">
			<div class="form-box">
			  <div class="form-value">
				<form method="post" action="<%=request.getContextPath()%>/LoginServlet" align="center" >
				  <h2>Login</h2>
