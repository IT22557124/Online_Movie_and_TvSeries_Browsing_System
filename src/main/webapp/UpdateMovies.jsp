...
<% 	
			...
			<form action="updatemovies" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-box" type="text" name="movieid" value="<%=rs.getString("movieid")%>"   required>
                            </div>

                            <!-- Form Group -->
                            <div class="form-group">
                            <label for="movie-input-field">Movie Name</label>
                                <input class="form-control input-box" type="text" name="movieName" value="<%=rs.getString("movieName")%>" placeholder="Celebrity Name" autocomplete="off"  required>
                            </div>
                            ...
                            <label for="movie-input-field">rating</label>
                                <input class="form-control input-box" type="text" name="rating" value="<%=rs.getString("rating")%>" placeholder="rating" autocomplete="off"  required>
                            </div>
                            ...
                            <div class="form-group text-center">
                                ...
                                <button class="btn btn-main btn-effect" type="submit" name="btnDeletemovies" value="deletemovies">Update movies</button>
                            </div>
